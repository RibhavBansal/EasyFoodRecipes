package com.example.easyfoodrecipes.fragment.bottomSheet
...
import com.example.easyfoodrecipes.databinding.FragmentMealBottomSheetBinding
...
class MealBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    private fun observeBottomSheetMeal() {
        viewModel.observeMealBottomSheetLiveData().observe(
            viewLifecycleOwner,
            Observer {meal->
                Glide.with(this)
